...
.. note:: Icons to be displayed at the Django CMS page requires *reference link* - for example from `AwsomeFonts <https://fontawesome.com/>`_ to be added at the *the base template header*.
